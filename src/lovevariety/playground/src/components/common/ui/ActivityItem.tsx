...
import { useForkRef } from "../../../utils/useForkRef.ts";
...
export function ActivityItem({
  ...
  children,
  ...props
}: PropsWithChildren<ComponentPropsWithRef<"div">> & { visible?: boolean }) {
  const localref = useRef<HTMLDivElement>(null);
  const forkedRef = useForkRef(ref, localref);
  useActivityPatch(localref);
  return (
    <div ref={forkedRef} {...props}>
...
export function useActivityPatch(ref: RefObject<HTMLDivElement | null>) {
  useEffect(() => {
